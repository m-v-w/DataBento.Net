...
public class LiveInstrumentDefinitions
{
    public static async Task InstrumentDefinitionsExample()
    { 
        ...
        var configuration = new ConfigurationBuilder().AddUserSecrets<LiveInstrumentDefinitions>().Build();
        ...
        await client.Subscribe([new SubscriptionKey(dataset, SchemaId.InstrumentDef, SymbolType.RawSymbol, "AAPL")], CancellationToken.None);
